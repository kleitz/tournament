...
class Template
{
	...
	/**
	 * Put extra meta tags, etc before all other head data
	 *
	 * @access	public
	 ...
	 * @return void
	 */
	public function add_styles($line) {
		array_unshift($this->_styles, $line);
		return $this;
	}
	
	
	/**
	 * Put  extra javascript only
	 * 
	 * @access public
	 * @param string $line 
	 * @return void
	 */
	public function add_scripts($line) {
		array_unshift($this->_scripts, $line);
		return $this;
	}


	/**
	 * Put extra meta tags, etc after other head data
	 *
	 * @access	public
	 * @param	 string	$line	The line being added to head
	 * @return	void
